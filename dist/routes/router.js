...
var require_Admin2 = __commonJS({
    "src/routes/Admin.ts": function(exports2, module2) {
        "use strict";
        var router2 = require("express").Router();
        var adminController = require_AdminController();
        router2.route("/admin").post(function(req, res) {
            return adminController.create(req, res);
        });
        router2.route("/admin").get(function(req, res) {
            return adminController.getAll(req, res);
        });
        router2.route("/admin/authenticate").put(function(req, res) {
...
var require_GuestsController = __commonJS({
    "src/controllers/GuestsController.ts": function(exports2, module2) {
        "use strict";
...
var require_Guests2 = __commonJS({
    "src/routes/Guests.ts": function(exports2, module2) {
        "use strict";
        var router2 = require("express").Router();
        var guestController = require_GuestsController();
        router2.route("/guest").post(function(req, res) {
            return guestController.create(req, res);
        });
        router2.route("/guest").get(function(req, res) {
            return guestController.getAll(req, res);
        });
        router2.route("/guestsmany").post(function(req, res) {
            return guestController.createMany(req, res);
        });
        router2.route("/guest/:id").get(function(req, res) {
            return guestController.get(req, res);
        });
        router2.route("/guest/:id").put(function(req, res) {
            return guestController.update(req, res);
        });
        router2.route("/guest/:id").delete(function(req, res) {
            return guestController.delete(req, res);
        });
        router2.route("/guest/sorted/:id").put(function(req, res) {
...
var require_GiftsControllers = __commonJS({
    "src/controllers/GiftsControllers.ts": function(exports2, module2) {
        "use strict";
        var GiftsModel = require_Gifts();
        var giftsController = {
            create: function() {
...
var require_Gifts2 = __commonJS({
    "src/routes/Gifts.ts": function(exports2, module2) {
        "use strict";
        var router2 = require("express").Router();
        var giftsController = require_GiftsControllers();
        router2.route("/gifts").post(function(req, res) {
            return giftsController.create(req, res);
        });
        router2.route("/giftsmany").post(function(req, res) {
            return giftsController.createMany(req, res);
        });
        router2.route("/gifts").get(function(req, res) {
            return giftsController.getAll(req, res);
        });
        router2.route("/gifts/:id").put(function(req, res) {
